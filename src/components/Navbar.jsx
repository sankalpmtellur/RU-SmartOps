        ...
        <header className="fixed top-0 left-72 right-0 h-24 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-10 z-40">
            ...
            <div className="flex items-center gap-6">
                ...
                <motion.button
                    ...
                    className="flex items-center gap-3 pl-4 pr-5 py-2.5 rounded-2xl border border-slate-100 bg-white hover:bg-red-50 hover:border-red-100 transition-all group"
                >
